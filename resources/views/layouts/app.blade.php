...
<div class="mobile-cart-bar" id="mobileCartBar">
    <div class="d-flex align-items-center gap-2">
        <span class="position-relative">
            ...
            <span class="cart-badge {{ $stickyCount ? '' : 'd-none' }}" data-cart-count>{{ $stickyCount }}</span>
        </span>
        <span>
            Kosár tartalma
            <small class="d-block opacity-90" data-cart-bar-summary>
                {{ $stickyCount }} termék · {{ number_format($stickyTotal, 0, ',', '.') }} Ft
            </small>
        </span>
    </div>
    <a href="{{ route('cart.index') }}">Kosár megtekintése →</a>
</div>
